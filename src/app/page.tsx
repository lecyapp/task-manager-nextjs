        ...
        <section className="py-20">
          <div className="text-center">
            <h1 className="text-5xl font-bold text-gray-900 mb-6">
              Welcome to <span className="text-gray-700">TaskMaster</span>
            </h1>
            ...
            <div className="flex gap-4 justify-center flex-wrap">
              ...
              <Link
                href="/login"
                className="bg-white hover:bg-gray-50 text-gray-800 px-8 py-3 rounded-lg font-semibold border-2 border-gray-800 transition"
              >
                Sign In
              </Link>
            </div>
